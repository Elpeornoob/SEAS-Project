...
public class Main {
    public static void main(String[] args) {
        ...
        Baggage baggage = new Baggage("baggageInfo", "baggageId", "weight", "wagonId");
        ...
        TicketModel model = new TicketModel(id, dateHourbuy, dateHourDeparture, dateHourArrival, route, passenger, ticketCategory, idTrain, place, ticketCost, contactPerson, baggage, seat);
