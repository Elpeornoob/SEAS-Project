...
public class Menu extends JFrame {
    ...
    public Menu() {
        ...
        RouteRepository routeRepository = new RouteRepository("src\\main\\java\\SantanderSAS\\Model\\DataBase\\route.json");
        ...
        TrainRepository trainRepository = new TrainRepository("src\\main\\java\\SantanderSAS\\Model\\DataBase\\train.json");
        ...
        UserRepository userRepository = new UserRepository("src\\main\\java\\SantanderSAS\\Model\\DataBase\\user.json");
